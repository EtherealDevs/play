      ...
      <div className="relative h-full w-full">
        ...
        <div className="absolute inset-0 grid h-full w-full place-items-center bg-black/40">
          <div className="w-3/4 text-center md:w-2/4">
            ...
            >
              Tenemos Variedad de Juegos y Juguetes para que tu Hijo se divierta
              y aprenda de la manera mas divertida
            </Typography>
          </div>
        </div>
      </div>
        ...
        <div className="absolute inset-0 grid h-full w-full items-center bg-black/40">
          <div className="w-3/4 pl-12 md:w-2/4 md:pl-20 lg:pl-32">
            ...
            <Typography
              ...
              className="mb-12 opacity-80 text-sm sm:text-xl"
            >
              Enseñamos a tu hijo cosas utiles para su desarrollo en la vida,
              dedicamos mucho tiempo para enseñar a tu hijo muchas cosas,
              preparate para que aprenda de la manera mas divertida
            </Typography>
          </div>
        </div>
      </div>
        ...
        <div className="absolute inset-0 grid h-full w-full items-end bg-black/40">
          <div className="w-3/4 pl-12 pb-12 md:w-2/4 md:pl-20 md:pb-20 lg:pl-32 lg:pb-32">
            ...
            <Typography
              ...
              className="mb-12 opacity-80 text-sm sm:text-xl"
            >
              Nuestro personal es el indicado para educar a tu Hijo, tenemos
              personal capacitado para educar y enseñar a tu hijo
            </Typography>
          </div>
        </div>
      </div>
