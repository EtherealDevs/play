          ...
          <div className="flex justify-center sm:px-5 md:flex-row">
            ...
            <div className="container mx-auto ">
              <div className="flex items-center justify-center w-full h-full py-24 sm:py-8 px-4">
                  ...
                  <CarouselProvider className="lg:block " naturalSlideWidth={100} isIntrinsicHeight={true} totalSlides={cantBlogs} visibleSlides={4} step={1} infinite={true}>
                      <div className="w-full relative flex items-center justify-center">
                          <ButtonBack role="button" aria-label="slide backward" className="absolute z-30 left-0 cursor-pointer" id="prev">
                              <svg width={8} height={14} viewBox="0 0 8 14" fill="none" xmlns="http://www.w3.org/2000/svg">
                                  <path d="M7 1L1 7L7 13" stroke="#8c4c9d" strokeWidth={2} strokeLinecap="round" strokeLinejoin="round" />
                              </svg>
                          </ButtonBack>
                                              ...
                                              <div className="bg-gray-800 rounded-2xl bg-opacity-30 absolute w-full h-full p-6">
                                                <div className='xl:h-[80%]'>
                                                  ...
                                                  <div className="flex xl:mb-10 justify-center items-center pb-6">
                                                      <ParseHTML classes={'justify-center lg:text-md font-semilight lg:leading-5 break-all text-white'} html={blog.content} />
                                                  </div>
                                                </div>
                          ...
                          <ButtonNext role="button" aria-label="slide forward" className="absolute z-30 -right-5 cursor-pointer text-black" id="next">
                              <svg width={8} height={14} viewBox="0 0 8 14" fill="none" xmlns="http://www.w3.org/2000/svg">
                                  <path d="M1 1L7 7L1 13" stroke="#8c4c9d" strokeWidth={2} strokeLinecap="round" strokeLinejoin="round" />
                              </svg>
                          </ButtonNext>
                      </div>
                  </CarouselProvider>
