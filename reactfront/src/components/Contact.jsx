...
function Contact() {
  return (
    ...
    <MapContainer className="h-3/5 w-5/6 flex justify-end rounded-3xl" center={{lat: '-27.4649353', lng: '-58.805059'}} zoom={14}>
    ...
    <div className="container px-5 h-5/6 my-12 mx-auto flex">
      <div className="lg:w-1/3 md:w-1/2 z-40 bg-white rounded-3xl p-8 flex flex-col md:ml-auto w-full mt-10 md:mt-0 relative shadow-md">
