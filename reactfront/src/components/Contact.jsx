...
function Contact() {
  ...
  <section className="text-gray-600 h-[100vh] w-screen flex content-center justify-center body-font relative">
    
    {/* Pantalla chica: h-5/6 w-5/6 */}
    {/* Pantalla Grande: h-3/5 w-5/6 */}
    <div className="w-11/12 rounded-3xl flex lg:justify-start justify-center">
    <MapContainer className=" lg:h-3/5 h-[90vh] w-11/12 rounded-3xl" center={{lat: '-27.4649353', lng: '-58.845059'}} zoom={14}>
    <div className="-z-40">
    <TileLayer url="https://tile.openstreetmap.org/{z}/{x}/{y}.png" attribution='&copy; <a href="https://www.openstreetmap.org/copyright">OpenStreetMap</a> contributors'/>
      <Marker position={{lat: '-27.4649353', lng: '-58.823859'}} iconUrl="../assets/location.svg">
      <Popup>
    ...
    <div className="z-40 absolute w-1/3 lg:px-5 lg:my-12 lg:mx-8 h-3/6 items-center justify-center flex lg:mt-10 mt-14">
      <div className="bg-white rounded-3xl p-8 flex items-center flex-col md:ml-auto 2xl:mt-10 mt-4 relative shadow-md">
