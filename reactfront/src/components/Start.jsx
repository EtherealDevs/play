...
function Start() {
  return (
    ...
    <div className="flex items-center justify-evenly flex-col h-full sm:pt-16 sm:pb-6 pt-14 pb-6 w-full">
           ...
           <div className="grid gap-10 grid-rows-3 mt-5 mb-5 lg:my-10 sm:grid-rows-1 sm:grid-cols-3 h-[90%] w-[70%] 2xl:h-96 xl:h-80 lg:h-72 md:h-72 lg:gap-10 cursor-default">
            <div className="bg-amber-100  rounded-xl h-full -translate-x-2 -translate-y-2">
                <div className="flex flex-col justify-center rounded-xl bg-white shadow-xl translate-x-2 translate-y-2 h-full group hover:bg-yellow-300 transition ease-in-out 300">
                    ...
                    <div className="hidden lg:block text-sm mt-6 font-light md:w-auto group-hover:block group-hover:text-black group-hover:font-bold group-hover:m-2 mx-2">Desarrollan empatía y responsabilidad social. Capacitandolos para el futuro</div>
                </div>
            </div>
            <div className="bg-blue-200  rounded-xl h-full -translate-x-2 -translate-y-2">
                <div className="flex flex-col justify-center rounded-xl bg-white shadow-xl translate-x-2 translate-y-2 h-full group hover:bg-blue-300 transition ease-in-out 300">
            ...
            <div className="bg-pink-200  rounded-xl h-full -translate-x-2 -translate-y-2">
                <div className="flex flex-col justify-center rounded-xl bg-white shadow-xl translate-x-2 translate-y-2 h-full group hover:bg-pink-300 transition ease-in-out 300">
                    ...
                    <div className="hidden lg:block text-sm mt-6 font-light md:w-auto group-hover:block transition ease-in-out 300 group-hover:text-black group-hover:font-bold group-hover:m-2 mx-2">Intentamos inspirar en ellos y en sus familias nuevas formas de entender y asimilar la realidad</div>
                </div>
            </div>
            </div>
