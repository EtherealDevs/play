        ...
        <div className="grid gap-10 grid-rows-3 mt-5 mb-5 lg:my-10 sm:grid-rows-1 sm:grid-cols-3 h-[90%] w-[70%] 2xl:h-96 xl:h-80 lg:h-72 md:h-72 lg:gap-10 cursor-default">
          <div className="bg-amber-100  rounded-xl h-full -translate-x-2 -translate-y-2">
            <div className="flex flex-col justify-center rounded-xl bg-white shadow-xl translate-x-2 translate-y-2 h-full group hover:bg-yellow-200 transition ease-in-out 300">
              <div className="group-hover:hidden transition ease-in-out 300 my-1 font-semibold text-md md:mx-5 md:mb-3">
                Emociones nuevas
              </div>
              <RiEmotionFill className="group-hover:hidden transition ease-in-out 300 w-auto text-6xl" />
              <div className="hidden lg:block text-sm mt-6 font-light md:w-auto group-hover:block group-hover:text-black group-hover:font-bold group-hover:m-2 mx-2">
          ...
          <div className="bg-blue-100  rounded-xl h-full -translate-x-2 -translate-y-2">
            <div className="flex flex-col justify-center rounded-xl bg-white shadow-xl translate-x-2 translate-y-2 h-full group hover:bg-blue-200 transition ease-in-out 300">
              <div className="my-1 font-semibold text-md md:mx-5 md:mb-3 group-hover:hidden transition ease-in-out 300">
                Desarrollo de la convivencia
              </div>
              <LuHeartHandshake className="w-auto text-6xl group-hover:hidden transition ease-in-out 300" />
              <div className="hidden lg:block text-sm mt-6 font-light md:w-auto group-hover:block transition ease-in-out 300 group-hover:text-black group-hover:font-bold group-hover:m-2 mx-2">
